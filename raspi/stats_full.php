...
// calculate values
// VBAT
system("/usr/bin/rrdtool graph /var/www/vbat_d.png --vertical-label='Raw Supply Voltage (V)' --start " . ($now-$hours*60*60+10) . " --end " . $now .
  " -w 720 -h 150 --right-axis 1:0 DEF:VBAT=/home/vic/galini.rrd:vbat:AVERAGE LINE:VBAT#FF5000 >/dev/null");
// current
...
// VCC
system("/usr/bin/rrdtool graph /var/www/vcc_d.png --vertical-label='Electronics Supply (V)' --start " . ($now-$hours*60*60+10) . " --end " . $now .
  " -w 720 -h 150 --right-axis 1:0 DEF:VCC=/home/vic/galini.rrd:vcc:AVERAGE LINE:VCC#600000 >/dev/null");
// CPU temp
system("/usr/bin/rrdtool graph /var/www/temp_d.png --vertical-label='CPU Temperature (°C)' --start " . ($now-$hours*60*60+10) . " --end " . $now .
  " -w 720 -h 150 --right-axis 1:0 DEF:TEMP=/home/vic/galini.rrd:temp:AVERAGE LINE:TEMP#004040 >/dev/null");
